...
You can check our Theme Instructions at https://catchthemes.com/themes/christmas-bell/ in the Theme Instructions Tab.

= Where can I find theme demo? =

You can check our Theme Demo at https://catchthemes.com/demo/christmas-bell/
...
= 1.1 (Released: March 22, 2018) =
* Bug Fixed: Design issue with Catch Infinite Scroll plugin
* Bug Fixed: Discarded use of 'create_function'
* Code Optimization

= 1.0.2 (Released: January 25, 2018) =
* Bug Fixed: Search box issue in iOS devices
* Bug Fixed: Default Catch Instagram Feed Gallery & Widget plugin style

= 1.0.1 ( Released: December 20, 2017 ) =
* Bug Fixed: Essential Widget featured posts compatibility css
* Bug Fixed: Infinite scroll loading button display
* Bug Fixed: Comment reply text issue

= 1.0 ( Released: December 13, 2017 ) =
* Bug Fixed: Infinite scroll button design issue
* Bug Fixed: Dropcap styling issue in ios devices
* Bug Fixed: Added SVG support for social widget
* Bug Fixed: Escaping issues on Social Widget
* Enhanced: Overall responsive design style

= 0.2 ( Released: December 10, 2017 ) =
* Bug Fixed: Search box issue in iOS devices
* Bug Fixed: Read more HTML structure
* Changed settings: Disable service by default
* Updated: Style to match with pro version color scheme

= 0.1 ( Released: December 6, 2017 ) =
* Initial release

== Copyright ==

Christmas Bell WordPress Theme, Copyright 2012-2019 Catchthemes.com
Christmas Bell is distributed under the terms of the GNU GPL
...
* Images
	...
	Source: https://www.pexels.com/photo/young-woman-in-snow-247119/

	Portfolio Images used in screenshot
	...
	https://www.pexels.com/photo/cat-under-the-christmas-tree-6279/
